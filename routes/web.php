...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::delete('customer-connectivity-surveys/photos/{photo}', [CustomerConnectivitySurveyController::class, 'destroyPhoto'])->name('customer-connectivity-surveys.photos.destroy');
