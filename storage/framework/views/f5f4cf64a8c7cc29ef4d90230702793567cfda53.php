...
<div class="modal custom-modal fade" id="chiefTechClearModal-<?php echo e($fault->id); ?>" tabindex="-1" aria-labelledby="chiefTechClearModalLabel-<?php echo e($fault->id); ?>" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <div class="fault-modal-header-copy">
          <h5 class="modal-title" id="chiefTechClearModalLabel-<?php echo e($fault->id); ?>"><i class="fas fa-check-circle me-2"></i>Confirm Clear</h5>
          <div class="text-muted small mt-1">Confirm final chief technician clearance for <?php echo e($fault->fault_ref_number ?? 'this fault'); ?>.</div>
          <div class="fault-modal-meta">
            <span class="fault-modal-meta-item"><i class="fas fa-user"></i> <?php echo e($fault->customer ?? 'N/A'); ?></span>
            <span class="fault-modal-meta-item"><i class="fas fa-link"></i> <?php echo e($fault->link ?? 'N/A'); ?></span>
          </div>
        </div>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="<?php echo e(route('chief-tech-clear.update',$fault->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div class="fault-modal-section-body">
              <div class="fault-modal-grid">
                <div class="fault-modal-kv">
                  ...
                  <div class="fault-modal-kv-value"><?php echo e($fault->customer ?? 'N/A'); ?></div>
                </div>
                <div class="fault-modal-kv">
                  <span class="fault-modal-kv-label">Link</span>
                  <div class="fault-modal-kv-value"><?php echo e($fault->link ?? 'N/A'); ?></div>
                </div>
                <div class="fault-modal-kv">
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/clear_faults/chief_tech_clear_modal.blade.php ENDPATH**/ ?>