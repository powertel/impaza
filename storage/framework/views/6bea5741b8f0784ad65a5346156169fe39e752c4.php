...
<div class="card faults-panel">
  <div class="faults-panel-header">
    ...
    <div class="faults-panel-actions">
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fault-create')): ?>
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li>
            <a class="dropdown-item" href="<?php echo e(route('faults.export.csv', request()->only('q','status','age','region'))); ?>">
              <i class="fas fa-file-excel me-2"></i>Export Excel
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="<?php echo e(route('faults.export.pdf', request()->only('q','status','age','region'))); ?>">
      ...
      <div class="faults-toolbar-grid">
          ...
          <div class="input-group input-group-sm">
            ...
            <select name="status" id="faultsStatusFilter" class="form-select form-select-sm" aria-label="Status filter">
              ...
              <?php $__currentLoopData = ($openStatuses ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($st->id); ?>" <?php echo e($statusFilter == (string) $st->id ? 'selected' : ''); ?>>
                  <?php echo e($compactStatusLabel($st->description)); ?>
        ...
        <div class="faults-toolbar-field faults-toolbar-search">
          <div class="input-group input-group-sm">
            ...
            <input type="text" name="q" value="<?php echo e(request('q', '')); ?>" class="form-control" placeholder="Search faults, customers, sites, managers...">
        ...
        <a href="<?php echo e(route('faults.index', ['per_page' => $perPage])); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3 faults-toolbar-reset">
            ...
            <tr>
              <td data-label="Ref. No.">
                <div class="faults-ref">
                  <a href="<?php echo e(route('faults.index', ['q' => $fault->fault_ref_number])); ?>"><?php echo e($fault->fault_ref_number); ?></a>
                  <span class="faults-cell-sub">Fault record</span>
                </div>
              </td>
              <td data-label="Customer">
                <div class="faults-cell-main"><?php echo e(Str::limit($fault->customer, 26)); ?></div>
              </td>
              <td data-label="Link">
                <div class="faults-cell-main"><?php echo e(Str::limit($fault->link, 34)); ?></div>
              </td>
              <td data-label="Switch">
                <div class="faults-cell-main"><?php echo e($latestRemark->switch_name ?? 'N/A'); ?></div>
              </td>
              <td data-label="Port">
                <div class="faults-cell-main"><?php echo e($latestRemark->port ?? 'N/A'); ?></div>
              </td>
              <td data-label="Assigned To">
                <div class="faults-cell-main <?php echo e($fault->assignedTo ? '' : 'text-muted'); ?>"><?php echo e($fault->assignedTo ?: 'Not yet assigned'); ?></div>
              </td>
              <td data-label="Date Reported">
                <div class="faults-cell-main"><?php echo e(Carbon\Carbon::parse($fault->created_at)->format('d M Y')); ?></div>
                <div class="faults-cell-sub"><?php echo e(Carbon\Carbon::parse($fault->created_at)->format('h:i a')); ?></div>
              </td>
              <td class="text-nowrap" data-label="Status">
                <a href="<?php echo e(route('faults.index', ['status' => $fault->status_id])); ?>" class="faults-status-link">
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status-badge','data' => ['label' => $statusLabel,'color' => $statusColor,'soft' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($statusLabel),'color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($statusColor),'soft' => true]); ?>
...
<?php endif; ?>
              ...
              <td class="text-end" data-label="Actions">
                <div class="faults-actions">
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fault-edit')): ?>
                    <?php if($fault->status_id != 6): ?>
                      <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editFaultModal-<?php echo e($fault->id); ?>">
                  ...
                  <button type="button" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#showFaultModal-<?php echo e($fault->id); ?>">
    ...
    <div class="faults-table-footer">
      ...
      <?php echo e($faults->appends(request()->except('page'))->links('pagination::bootstrap-5')); ?>

    </div>
  </div>
</div>

<?php echo $__env->make('faults.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__currentLoopData = $faults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fault): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php if($fault->status_id != 6): ?>
    <?php echo $__env->make('faults.edit', [
        'fault' => $fault,
        'customers' => $customer,
        'cities' => $city,
        'suburbs' => $location,
...
<?php $__env->startSection('scripts'); ?>
    <?php echo $__env->make('partials.faults', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/faults/index.blade.php ENDPATH**/ ?>