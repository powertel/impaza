...
<head>
    ...
    <title>Fault Received: <?php echo e($fault_ref); ?></title>
    <style>
        body {
            margin: 0;
            padding: 16px 10px;
    ...
    <div class="container">
        <div class="hero" style="background:#eef5ff; color:#142033; padding:24px 26px 18px; border-bottom:1px solid #d7e5ff; border-top:6px solid #1f6feb;">
            <div class="letterhead" style="margin-bottom:10px; text-align:center;">
                <img src="<?php echo e($message->embed(public_path('img/powertel.png'))); ?>" alt="PowerTel Communications" style="display:block; max-width:180px; width:100%; height:auto; margin:0 auto;">
            </div>
            ...
            <table class="hero-meta" role="presentation" style="width:100%; margin-top:12px; border-collapse:separate; border-spacing:0 6px;">
                <tr>
                    <td style="width:100%; padding:10px 12px; border-radius:12px; background:#ffffff; border:1px solid #d7e5ff; vertical-align:top;">
                        ...
                        <span class="meta-value" style="display:block; font-size:13px; font-weight:700; color:#0f172a; line-height:1.35;"><?php echo e($fault_ref); ?></span>
                    </td>
                </tr>
                <tr>
                    <td style="width:100%; padding:10px 12px; border-radius:12px; background:#ffffff; border:1px solid #d7e5ff; vertical-align:top;">
                        ...
                        <span class="meta-value" style="display:block; font-size:13px; font-weight:700; color:#0f172a; line-height:1.35;"><?php echo e($customer); ?></span>
                    </td>
                </tr>
                <tr>
                    <td style="width:100%; padding:10px 12px; border-radius:12px; background:#ffffff; border:1px solid #d7e5ff; vertical-align:top;">
                        ...
                        <span class="meta-value" style="display:block; font-size:13px; font-weight:700; color:#0f172a; line-height:1.35;"><?php echo e($received_at); ?></span>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> PowerTel Communications. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/html/resources/views/emails/fault_received.blade.php ENDPATH**/ ?>