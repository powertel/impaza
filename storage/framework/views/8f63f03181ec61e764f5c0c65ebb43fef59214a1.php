  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    function bindRowEvents(tr){
      ...
      linkInput.addEventListener('input', function(){
        ...
        debounce(this, function(){
          if (!val) return;
          $.get(`<?php echo e(route('links.check-link-name')); ?>`, { link: val, ignore_id: ignoreId })
            .done(function(res){
              if (!res.available) {
    ...
    function loadLinksForCustomer(custId){
      ...
      $.get(`<?php echo e(url('links/customer')); ?>/${custId}`, function(items){
        $(tbody).empty();
...
</script><?php /**PATH /var/www/html/resources/views/links/partials/scripts.blade.php ENDPATH**/ ?>