    ...
    */
    ...
    public function linksForCustomer($customerId)
    {
        ...
        $links = Link::where('customer_id', $customerId)->get([
            'id','link','city_id','suburb_id','pop_id','linkType_id','customer_id','service_type','capacity'
        ]);
    ...
    public function autosave(Request $request, $id)
    {
        ...
        if ($request->has('service_type')) {
            $rules['service_type'] = ['nullable','string','in:Internet,Metro VPN,Intercity VPN,Carrier Services,E-Vending,Dark-Fibre'];
        }
