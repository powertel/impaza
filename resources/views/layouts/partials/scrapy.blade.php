...
<!--                     <span class="logo-lg">
                ...
                <!-- Sidebar Menu -->
                @php
                  $configOpen = request()->routeIs('users.*') || request()->routeIs('roles.*') || request()->routeIs('permission.*') || request()->routeIs('departments.*') || request()->routeIs('sections.*') || request()->routeIs('positions.*') || request()->routeIs('account_managers.*') || request()->routeIs('cities.*') || request()->routeIs('locations.*') || request()->routeIs('pops.*') || request()->routeIs('customers.*') || request()->routeIs('links.*');
                  $assessOpen = request()->routeIs('assessments.*') || request()->routeIs('rfos.*');
                  $permitsOpen = request()->routeIs('permits.*') || request()->routeIs('request-permit.*');
                @endphp
                <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview {{ $assessOpen ? 'menu-open' : '' }}">
                      <a href="#" class="nav-link {{ $assessOpen ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-treeview {{ $permitsOpen ? 'menu-open' : '' }}">
                      <a href="#" class="nav-link {{ $permitsOpen ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-treeview {{ $configOpen ? 'menu-open' : '' }}">
