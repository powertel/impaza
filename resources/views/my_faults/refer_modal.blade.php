  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="px-3 pb-2">
        ...
        <div id="referRemarksScroller-{{ $fault->id }}" class="js-remarks-list" style="max-height: 420px; overflow-y: auto; padding-right: 6px;">
            ...
            <div class="d-flex {{ $isOwn ? 'justify-content-end' : 'justify-content-start' }} mb-3">
              <div class="rounded-3 shadow-sm px-3 py-2" style="max-width: 75%; background-color: {{ $isOwn ? '#e8f5e9' : '#eef5ff' }};">
                ...
                @if($remark->file_path)
                  ...
                  <div class="modal custom-modal fade" id="ReferPicModal-{{ $remark->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="ReferPicModalLabel-{{ $remark->id }}" aria-hidden="true">
