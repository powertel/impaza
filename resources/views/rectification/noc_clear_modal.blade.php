          ...
          <div class="mt-3">
            <div class="row g-2">
              <div class="col-md-6">
                ...
                <input type="text" name="switch_name" class="form-control" value="{{ old('switch_name', $latestRemarkForNocClear->switch_name ?? '') }}" placeholder="Enter switch name or identifier">
              </div>
              <div class="col-md-6">
                <label class="form-label">Port</label>
                <input type="text" name="port" class="form-control" value="{{ old('port', $latestRemarkForNocClear->port ?? '') }}" placeholder="Enter port number or label">
              </div>
              <div class="col-md-12">
