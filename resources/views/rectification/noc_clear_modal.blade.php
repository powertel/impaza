    ...
    <div class="modal-content">
      ...
      <form action="{{ route('noc-clear.update',$fault->id) }}" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="mt-3">
            <label for="nocClearRemark-{{ $fault->id }}" class="form-label mb-1">Remarks</label>
            <textarea id="nocClearRemark-{{ $fault->id }}" name="remark" class="form-control" rows="3" required></textarea>
          </div>
        </div>
