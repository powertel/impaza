            ...
            <div class="card-body">
                <form action="{{ route('finance.update', $link->id ) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Enter Contract Number" class="form-control @error('contract_number') is-invalid @enderror"  name="contract_number"  value="{{ old('contract_number') }}">
                        </div>
                    </div>
