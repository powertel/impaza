...
<div class="modal custom-modal fade" id="customerEditModal{{ $customer->id }}" tabindex="-1" aria-labelledby="customerEditModalLabel{{ $customer->id }}" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <div class="fault-modal-header-copy">
          <h5 class="modal-title" id="customerEditModalLabel{{ $customer->id }}"><i class="fas fa-pen-to-square me-2"></i>Edit Customer</h5>
          ...
          <div class="fault-modal-meta">
            ...
            <span class="fault-modal-meta-item"><i class="fas fa-hashtag"></i> {{ $customer->account_number ?? 'No Account' }}</span>
          </div>
        </div>
