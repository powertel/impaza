    ...
    <div class="modal-content rounded-4 border-0 shadow-lg">
      <div class="modal-header border-0">
        <div class="d-flex align-items-center">
          <span class="badge bg-primary me-2"><i class="fas fa-clipboard"></i></span>
          <div>
            <h5 class="modal-title mb-0" id="lteSurveyViewModalLabel-{{ $survey->id }}">View LTE Site Survey</h5>
            <small class="text-muted">#{{ $survey->id }} • {{ $survey->site_name ?: 'Untitled' }} • {{ $survey->status === 'submitted' ? 'Submitted' : 'Draft' }}</small>
          </div>
        </div>
