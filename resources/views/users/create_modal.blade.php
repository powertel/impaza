        ...
        <form id="user-create-form" action="{{ route('users.store') }}" method="POST">
          ...
          <div class="row g-3 mt-1">
            ...
            <div class="col-md-6">
              ...
              <div class="password-wrapper">
            <input id="create_password_confirm" type="password" class="form-control @error('confirm-password') is-invalid @enderror" name="confirm-password" placeholder="Confirm Password" minlength="8" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^A-Za-z0-9]).+" autocomplete="new-password">
