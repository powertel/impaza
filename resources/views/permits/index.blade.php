...
<div class="card">
    ...
    <div class="card-header">
        <h3 class="card-title">Approved Permits</h3>
        ...
        <div class="table-responsive">
            <div class="d-flex justify-content-end align-items-center gap-2 mb-2">
                <div class="input-group input-group-sm" style="width: 170px;">
                    ...
                    <select id="permitsPageSize" class="form-select form-select-sm" style="width:auto;">
            ...
            <table  class="table table-hover js-paginated-table" data-page-size="20" data-page-size-control="#permitsPageSize" data-pager="#permitsPager" data-search="#permitsSearch">
                ...
                <tr>
                    ...
                    <th>Freedom</th>
                    <td>
                        <button  class="btn btn-sm btn-outline-info" data-bs-toggle="modal" data-bs-target="#showPermitModal">
