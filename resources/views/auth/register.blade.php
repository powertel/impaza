  ...
  <div class="login-card">
    ...
    <form action="{{ route('register') }}" method="post">
      ...
      <div class="form-group">
        ...
        <input id="name" type="text" placeholder="Enter your Name" class="form-control custom @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
        @error('name')
      ...
      <div class="form-group">
        ...
        <input id="email" type="email" placeholder="Enter your Email" class="form-control custom @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
        @error('email')
          <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
        @enderror
      </div>
