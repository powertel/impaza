  ...
  <div class="login-card">
    ...
    <form method="POST" action="{{ route('password.update') }}">
      ...
      <div class="form-group">
        ...
        <input id="email" type="email" placeholder="Enter your Email" class="form-control custom @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
        @error('email')
      ...
      <div class="form-group">
        ...
        <div class="password-wrapper">
            <input id="password" type="password" placeholder="Enter New Password" class="form-control custom @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" minlength="8" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^A-Za-z0-9]).+">
      ...
      <div class="form-group">
        ...
        <div class="password-wrapper">
            <input id="password-confirm" type="password" placeholder="Confirm New Password" class="form-control custom" name="password_confirmation" required autocomplete="new-password" minlength="8" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^A-Za-z0-9]).+">
      ...
      <button type="submit" class="btn btn-primary modern">Reset Password</button>
    </form>
  </div>
</div>
@endsection
