...
CREATE TABLE `faults` (
  ...
  `root_fault_id` int unsigned DEFAULT NULL,
  `fault_ref_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` int unsigned NOT NULL,
  `phoneNumber` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `accountManager_id` int unsigned NOT NULL,
  `city_id` int unsigned DEFAULT NULL,
  `suburb_id` int unsigned DEFAULT NULL,
  `pop_id` int unsigned DEFAULT NULL,
  `link_id` int unsigned NOT NULL,
  `suspectedRfo_id` int unsigned NOT NULL,
  `confirmedRfo_id` int unsigned DEFAULT NULL,
  `serviceType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serviceAttribute` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `priorityLevel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_id` int unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `faults_root_fault_id_index` (`root_fault_id`)
...
-- Dump completed on 2026-03-31 11:51:35
