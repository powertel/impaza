...
CREATE TABLE `faults` (
  ...
  `fault_ref_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` int unsigned NOT NULL,
  `phoneNumber` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `serviceAttribute` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `priorityLevel` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
